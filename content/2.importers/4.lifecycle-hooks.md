...
::warning
**Not yet implemented.** This hook is defined in the importer contract but is not currently invoked by the validation pipeline. It will be connected in a future release. Do not rely on it for critical logic.
::
