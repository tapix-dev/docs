...
```php
'readers' => [
    'csv' => \Tapix\Core\Readers\CsvReader::class,
    'txt' => \Tapix\Core\Readers\CsvReader::class,
    'xlsx' => \Tapix\Core\Readers\XlsxReader::class,
],
```

You can register custom reader classes for additional file formats. Each reader must implement the `Tapix\Core\Contracts\Reader` interface. See the [Custom Readers](/advanced/custom-readers) section for details.
