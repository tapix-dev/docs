...
The [Livewire wizard](/integration/livewire#supported-file-types) reads the same mapping to decide which files the upload step accepts, so a newly registered reader needs no further wiring.
